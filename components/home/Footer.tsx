      ...
      <div className="w-[90%] max-w-[1280px] mx-auto">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-6 text-base text-gray-500 dark:text-gray-400">
              InfoYantra, a web agency, provides innovative brand development
              and technical SEO solutions.
            </p>
            <ul className="font-medium flex gap-2 pt-4">
              <li className="hover:animate-scale rounded-md h-8 w-8 bg-orange-300 flex items-center justify-center">
                <Link href="/">
                  <FaFacebookF />
                </Link>
              </li>
        ...
        <div className="px-4 py-6  dark:bg-gray-700 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2023 <Link href="/">InfoYantra™</Link>. All Rights Reserved.
          </span>
